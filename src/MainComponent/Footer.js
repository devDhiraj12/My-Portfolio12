  ...
  return (
    <div className="footerBack  h-[650px] md:h-full">
      <div className="   grid  grid-cols-1 md:grid-cols-3 gap-12  p-5 md:p-8 text-center">
        <div className=" ">
          <div>
            <ul className=" flex justify-center items-center mt-24 gap-9 ">
              <li className=" w-[25px]   md:hover:-translate-y-2 duration-700 hover:duration-300  ">
                <a href="https://www.linkedin.com/in/dhiraj-dagabaj-1a3573248/">
                  <img src={linkedin} alt="under-heading" />
                </a>
              </li>
              <li className=" w-[25px]  hmd:over:-translate-y-2 duration-700 hover:duration-300 ">
